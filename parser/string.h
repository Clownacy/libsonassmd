...
bool StringView_Compare(const StringView *view, const StringView *other_view);
bool StringView_CompareCStrCaseInsensitive(const StringView *view, const char *c_string);
size_t StringView_Find(const StringView *view, const StringView *sub_view, size_t position, bool case_insensitive);
...
bool String_CreateInternal(String *string, const char *source_1_buffer, size_t source_1_length, const char *source_2_buffer, size_t source_2_length);
#define String_Create(OUTPUT, INPUT_BUFFER, INPUT_LENGTH) String_CreateInternal(OUTPUT, INPUT_BUFFER, INPUT_LENGTH, NULL, 0)
bool String_CreateCopyView(String *string, const StringView *source);
#define String_CreateCopy(OUTPUT, INPUT) String_CreateCopyView(OUTPUT, String_View(INPUT))
bool String_CreateAppendView(String *string, const StringView *source_1, const StringView *source_2);
...
bool String_Replace(String *string, size_t position, size_t count, const StringView *other_string);
bool String_Reserve(String *string, size_t size);
bool String_Resize(String *string, size_t size);
bool String_ResizeNoFill(String *string, size_t size);
