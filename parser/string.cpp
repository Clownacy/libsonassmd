...
bool StringView_Compare(const StringView* const view, const StringView* const other_view)
{
...
bool StringView_CompareCStrCaseInsensitive(const StringView* const view, const char* const c_string)
{
...
size_t StringView_Find(const StringView* const view, const StringView* const sub_view, const size_t position, const bool case_insensitive)
{
	size_t i;
...
bool String_CreateInternal(String* const string, const char* const source_1_buffer, const size_t source_1_length, const char* const source_2_buffer, const size_t source_2_length)
{
	bool success = true;
...
bool String_CreateCopyView(String* const string, const StringView* const source)
{
...
bool String_CreateAppendView(String* const string, const StringView* const source_1, const StringView* const source_2)
{
...
bool String_Replace(String* const string, const size_t position, const size_t count, const StringView* const other_string)
{
	assert(string != NULL);
...
bool String_Reserve(String* const string, const size_t size)
{
	assert(string != NULL);

	{
		/* As an optimisation, we do not shrink the buffer. */
		const size_t new_capacity = size > string->capacity ? size : string->capacity;
...
bool String_Resize(String* const string, const size_t size)
{
	assert(string != NULL);
...
bool String_ResizeNoFill(String* const string, const size_t size)
{
	assert(string != NULL);
